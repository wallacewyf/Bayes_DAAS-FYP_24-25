...
esg_scores = source_df.iloc[:, [0,1] + list(range(22,42))]
...
e_pillars = source_df.iloc[:, [0,1] + list(range(42,62))]
...
s_pillars = source_df.iloc[:, [0,1] + list(range(62,82))] 
...
g_pillars = source_df.iloc[:, [0,1] + list(range(82,102))]
