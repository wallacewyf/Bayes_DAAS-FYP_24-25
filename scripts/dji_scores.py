...
# init source df
source_df = pd.read_excel(config.dji_esg, index_col=0, skiprows=2)
...
esg_scores.sort_values(by=[2023, 'Company Name'],
                       axis=0,
...
e_pillars.sort_values(by=[2023, 'Company Name'],
                       axis=0,
                       ascending=[False, True],
                       inplace=True)
...
s_pillars.sort_values(by=[2023, 'Company Name'],
                       axis=0,
                       ascending=[False, True],
                       inplace=True)
...
g_pillars.sort_values(by=[2023, 'Company Name'],
                       axis=0,
                       ascending=[False, True],
                       inplace=True)
